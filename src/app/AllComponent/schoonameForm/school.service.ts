...
export class SchoolService {
  ...
  Add(formval : any): Observable<any>{
    ...
    return this.http.post(routeurls.BASE_API_URL + routeurls.SCHOOL_ADD_URL,formval,options)
  }
  ...
  getbyid(id: any): Observable<any> {
    return this.http.get<any>(routeurls.BASE_API_URL + routeurls.SCHOOL_ADD_URL+ "/getbyid", { params: new HttpParams().set('id', id) })
    .pipe(
      retry(3),
      map(res => {
        console.log(res);
  ...
  update(id: any, obj: any): Observable<any> {
    obj.Id = id;
    console.log(obj);
    return this.http.put<any>(routeurls.BASE_API_URL + routeurls.SCHOOL_ADD_URL , obj)
    .pipe(
      retry(3),
      map(res => {
        console.log(res);
  ...
  delete(id: any): Observable<any> {
    return this.http.delete<any>(routeurls.BASE_API_URL + routeurls.SCHOOL_ADD_URL, { params: new HttpParams().set('id', id) });
  }
}
