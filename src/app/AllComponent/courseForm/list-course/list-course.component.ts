...
export class ListCourseComponent implements OnInit {
  ...
  displayedColumns: string[] = ['schoolName','courseName','noOfCandidates','startDate','endDate','buttons'];
  displayedColumnsName: string[] = ['schoolName','buttons'];
  AllElement: MatTableDataSource<any>;
  constructor(private snackBar: MatSnackBar, private empService: CourseService, public dialog: MatDialog,
  ...
  onUpdate(id) {
    this._router.navigate(['/editCourse', id]);
  }
